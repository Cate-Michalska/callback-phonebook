...
def search():
    ...
    for i in range(len(res)):
        ...
        display_button = tk.Button(contacts_sect, text = res[i], fg = 'green', activebackground = 'green', activeforeground='red', height = 1, command = searchDisplay, borderwidth = 0, font = "Helvetica 15 bold").place(x = 15, y = 38+(i*30))
...
add_button = tk.Button(new_w, text = "Add contact", activebackground="green", activeforeground="red",height=1, command=contact).place(x = 210, y = 20)
enter_label = tk.Entry(new_w, width="20", background="white", foreground="blue", textvariable = entry).place(x = 30, y=20)
search_button = tk.Button(new_w, text = "Search", activebackground = "green", activeforeground = "red", height = 1, command = search).place(x=160, y=20)
...
def searchDisplay():
    ...
    new2.geometry = ("350x450")
    display_sect = tk.Canvas(new2, width="350", background="#7ED957", height = 120)
    display_sect.create_text(175, 60, text = ("Filler"), fill="white",font = "Helvetica 22 bold")

    display_sect2 = tk.Canvas(new2, width="350", background="white", height = 320)

    display_sect2.create_text(90, 40, text = "Filler",fill='grey', font="Helvetica 15 bold")
    phoneNumber_entry = tk.Entry(display_sect2,background="white",highlightbackground="grey",highlightthickness=4,foreground="black")
    phoneNumber_entry.place(x = 40, y = 70,width = 200)
    phoneNumber_entry.insert(0, phoneNumber.get())

    display_sect2.create_text(70, 120, text= "Filler", fill ="grey", font = "Helvetica 15 bold")
    birthday_entry = tk.Entry(display_sect2,background="white",highlightbackground="grey",highlightthickness=4,foreground="black")
    birthday_entry.place(x = 40, y = 150, width = 200)
